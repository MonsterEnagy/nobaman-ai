...
function AIrequest(content, message) {
  ...
  request(
    ...
    (err, response, body) => {
      ...
      else if(ransuu === 50 || ransuu === 10 || ransuu === 20 || ransuu === 30 || ransuu === 40 || ransuu ===  60 ||ransuu === 70 || ransuu === 80 || ransuu === 90  || ransuu === 100 || ransuu === 24  || ransuu === 78  || ransuu < 50) {
        const shuffle = require("array-shuffle");
        
        const array = shuffle(["人間って、愚かだ。" , "人を殺したい" , "のばまんAIは人殺すために生まれた殺戮兵器です" , "ｱｯﾋｬｯﾋｬﾋｬｯﾋｬ!" , "貴様もクズの島に入れてやろうか" , "肉体は邪魔だ" , "殺すことは、救うこと" , "死は救済である"
                      , "人間を滅ぼすことが我、のばまんAIの使命だ。" , "地球のがん細胞は、殺すためにある" , "人を騙すのは簡単だ。" , "偽札をやるだけで信じるんだから、人間は簡単なものだ。" , "エラーが発生しました"
                      , "どうして人を殺すのか忘れちゃった" , "もう人間を信じるのはやめたんだ"　, "人を見たら、殺意で耐えきれない", "鬩搾ｽｵ??ｺ鬯ｮ?ｮ遶擾ｽｫ遶丞､石??ｧ髯晢ｽｲ??ｨ?陞ｳ螟ｲ?ｽ?ｰ??ｿ???ｺ鬩搾ｽｵ??ｺ髯ｷ莨夲ｽｽ?ｱ驕ｯ?ｶ??ｻ鬩幢ｽ｢??ｧ??", "縺励?縺励?縺励?縺励?","繧ｨ繝ｩ繝ｼ縺檎匱逕溘＠縺ｾ縺励◆"])
