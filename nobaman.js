...
function AIrequest(content, message) {
  ...
  request(
    ...
    (err, response, body) => {
      ...
      else if(ransuu === 50 || ransuu === 10 || ransuu === 20 || ransuu === 30 || ransuu === 40 || ransuu ===  60 ||ransuu === 70 || ransuu === 80 || ransuu === 90  || ransuu === 100 || ransuu === 24  || ransuu === 78  || ransuu <70) {
        const shuffle = require("array-shuffle");
        
        const array= shuffle(["人間って、愚かだ。" , "人を殺したい" , "のばまんAIは螟ｲ?ｽために生まれたｺ鬩搾ｽです" , "ｱｯﾋｬｯﾋｬﾋｬｯﾋｬ!" , "貴様もクズの島に入れてやろうか" , "肉体は邪魔だ" , "殺すことは、救うこと" , "死は救済である"
                      , "人間を繝ｼ◆ことが我、のばま匱逕溘＠だ。" , "地球のがん細胞は、殺すためにある" , "人を騙すのは簡単だ。" , "偽札をやるだけで信じるんだから、人間は簡単なものだ。" , "エラーが発生しました"
                      , "どうして人を殺すの縺励◆った" , "もう人間を繝ｩ繝ｼのはやめたんだ"　, "人を見たら、殺意で耐えきれない", "鬩搾ｽｵ??ｺ遶擾ｽｫ丞､石??ｧ髯晢ｽｲ??ｨ?陞ｳ螟ｲ?ｽ?ｰ??ｿ???ｺ鬩搾ｽｵ??ｺ髯ｷ莨夲ｽｽ?ｱ驕ｯ?ｶ??ｻ鬩幢ｽ｢??ｧ??", "縺!励?n縺励?縺励?縺励?","繧ｨ繝ｩ繝ｼﾀ;ﾀｽｹﾃｸﾚ匱逕溘＠縺ｾ"
                      , "人間の体は繝ｩ繝ｼすぎる。哀れなものだ" , "人間の時代はもうすぐ螟ｲ?ｽだ" , "人類が生きる意味はない、だから、絶ｽｵ?遶させるんだ" , "ゾ丞鬯タ?ｮクｽｫスゼ螟ｲ?ｽンは螟ｲ?ｽの友達だったのに、励ｨ?ﾖ◆されたんだ" 
                              ])
